...
class TaskMetrics private[spark] () extends Serializable {
  ...
  @transient private[spark] lazy val nameToAccums = LinkedHashMap(
    ...
    shuffleRead.ORIGINAL_BLOCK_FALLBACK_COUNT -> shuffleReadMetrics._fallbackCount,
    ...
    shuffleRead.REMOTE_MERGED_BLOCKS_READ -> shuffleReadMetrics._remoteMergedBlocksBytesRead,
    shuffleRead.LOCAL_MERGED_BLOCKS_READ -> shuffleReadMetrics._localMergedBlocksBytesRead,
