...
class StageData private[spark](
    ...
    val shuffleReadRecords: Long,
    val pushBasedShuffleCorruptMergedBlockChunks: Long,
    val pushBasedShuffleFallbackCount: Long,
    val pushBasedShuffleMergedRemoteBlocksFetched: Long,
    val pushBasedShuffleMergedLocalBlocksFetched: Long,
    val pushBasedShuffleMergedRemoteChunksFetched: Long,
    val pushBasedShuffleMergedLocalChunksFetched: Long,
    val pushBasedShuffleMergedRemoteBytesRead: Long,
    val pushBasedShuffleMergedLocalBytesRead: Long,
    val pushBasedShuffleRemoteReqsDuration: Long,
    val pushBasedShuffleMergedRemoteReqsDuration: Long,
    val shuffleWriteBytes: Long,
    val shuffleWriteTime: Long,
    val shuffleWriteRecords: Long,
    val pushBasedShuffleBlocksNotPushed: Long,
    val pushBasedShuffleBlocksCollided: Long,
    val pushBasedShuffleBlocksTooLate: Long,
